...
export interface AllStandardOpsTestInterface extends utils.Interface {
  functions: {
    ...
    "runContext(uint256[][],uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "run(uint256)",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(functionFragment: "run()", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "runContext(uint256[][],uint256)",
    values: [PromiseOrValue<BigNumberish>[][], PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "runContext(uint256[][])",
    values: [PromiseOrValue<BigNumberish>[][]]
  ): string;
